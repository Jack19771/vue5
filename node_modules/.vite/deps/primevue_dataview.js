import {
  script as script5
} from "./chunk-ENX4TJ7G.js";
import "./chunk-HVOBYOMA.js";
import {
  script2 as script3,
  script3 as script4
} from "./chunk-KD4HZCUV.js";
import "./chunk-ATPJDXG2.js";
import {
  Ripple
} from "./chunk-BKIXXNPD.js";
import "./chunk-NFB7N2VM.js";
import {
  script as script2
} from "./chunk-PUR5PWKT.js";
import "./chunk-IUCQYH5B.js";
import {
  script
} from "./chunk-22A7MCCJ.js";
import "./chunk-B73TEBOQ.js";
import "./chunk-BZN6RTID.js";
import "./chunk-X3KIWTM4.js";
import {
  BaseStyle
} from "./chunk-HNP6FU7V.js";
import {
  clearSelection,
  cn,
  getSelection,
...
var script9 = {
  ...
  methods: {
    ...
    onPaste: function onPaste(event) {
      event.preventDefault();
      var data5 = (event.clipboardData || window["clipboardData"]).getData("Text");
      if (data5) {
        var filteredData = this.parseValue(data5);
...
var script14 = {
  ...
  methods: {
    ...
    sort: function sort$1() {
      var _this = this;
      if (this.value) {
        var value = _toConsumableArray2(this.value);
  ...
  computed: {
    ...
    items: function items() {
      if (this.value && this.value.length) {
        ...
        if (data5 && data5.length && this.sortField) {
          data5 = this.sort();
        }
        if (this.paginator) {
          var first4 = this.lazy ? 0 : this.d_first;
          return data5.slice(first4, first4 + this.d_rows);
        } else {
          return data5;
        }
      } else {
